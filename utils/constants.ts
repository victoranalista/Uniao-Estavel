...
export const NACIONALIDADES = [
  ...
  'Catar', 'Cazaque', 'Chadiana', 'Chilena', 'Chinesa', 'Cipriota', 'Colombiana',
...
export const OFICIAIS_REGISTRADORES: Record<string, string> = {
  'André Victor Alves de Sousa': 'Oficial Registrador',
  'Karina Alves Barbosa': 'Oficial Substituta',
  'Daniella dos Santos': 'Escrevente Autorizada',
  'Myllena Areda Fernandes': 'Escrevente Autorizada'
};
...
export const MUNICIPIOS_BRASIL = [
  { nome: 'Brasília', uf: 'DF' },
